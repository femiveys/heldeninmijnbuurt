          ...
          description={
            <Typography>
              <Paragraph type="secondary">
                Wij gebruiken cookies om je gebruikservaring te verbeteren. Dit
                platform heeft geen enkel commercieel oogmerk. We gebruiken dan
                ook enkel technische cookies en dus geen cookies voor marketing
                doeleinden.
              </Paragraph>
              <Paragraph type="secondary">
